...
## Phase 2: <Short Vertical Slice Title>
...
| ID     | Acceptance Criterion                                         | User Story ID(s) | Functional Requirement ID(s) | Non-Functional Requirement ID(s) |
| ------ | ------------------------------------------------------------ | ---------------- | ---------------------------- | -------------------------------- |
| AC-004 | Given <context>, when <action>, then <observable outcome>.   | US-001           | FR-001                       | NFR-001                          |
| AC-005 | Given <edge case>, when <action>, then <expected behaviour>. | US-001           | FR-002                       | NFR-002                          |
| AC-006 | <actor> can <behaviour> <condition>.                         | US-001           | FR-001, FR-002               | NFR-001                          |
