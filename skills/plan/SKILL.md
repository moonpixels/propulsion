...
9. Tell the user the plan is complete and ask whether to move to `execute`.
...
- [ ] User asked whether to move to `execute`.

## Next Steps

Once the completion gate is fully checked:

- If the user says to proceed, enter the `execute` skill.
- If product intent is missing, enter the `brainstorm` skill.
