...
Read repository instructions and establish the authorised scope, expected
...
Gather evidence and state falsifiable hypotheses in evidence-supported
...
When the user explicitly requested diagnosis only, stop before mutation and
...
Re-run the original reproduction and confirm the expected behaviour, then
