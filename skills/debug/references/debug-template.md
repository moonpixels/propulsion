...
- `debug.md` starts or resumes in `debug` and stays the single living bug artifact for later loops.
...
- If expected behaviour is unknowable, keep asking or block in `debug`; do not route to fixing.
