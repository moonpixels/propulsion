...
- DO NOT start `plan` here.
- If you cannot write files, STOP, ask the user to switch to build mode, and tell them to return to `brainstorm` so you can write `prd.md`.
