...
Resolve the change scope in this order: an explicit caller-supplied scope,
...
Read repository instructions, relevant context and decisions, changed files
...
Perform a **requirements traceability** pass. Compare the change with every
...
Perform an independent code-health pass across correctness, design,
...
Apply **falsification** to every candidate against the scoped change, full
...
Use **risk-based prioritisation**: `critical` for immediate data loss,
