...
2. Load the `tdd` skill NOW and follow the guidance when implementing features or bug fixes.
...
- ALWAYS load and use the `tdd` skill when implementing features or bug fixes.
