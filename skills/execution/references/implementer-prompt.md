...
2. If the task involves behavioural changes, load the `tdd` skill NOW and follow the guidance.
...
- ALWAYS load and use the `tdd` skill for any behavioural changes, and follow its guidance for test-first implementation.
