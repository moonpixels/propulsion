...
**Test-driven development** builds one observable behaviour at a time through
red-green-refactor. Use **Classicist TDD** to test stable public seams with real
internal collaborators, introducing doubles mainly at uncontrollable boundaries.
...
Apply the **Test Desiderata** to retain tests that are isolated, composable,
fast, inspiring, writable, readable, behavioural, structure-insensitive,
automated, specific, deterministic, and predictive. Retained tests remain
unchanged when production code is refactored without changing observable
behaviour; when structure alone breaks a test, move its assertions to the public
outcome. Prefer assertions on public outcomes over CSS classes, incidental DOM
shape, private methods, internal call sequences, broad snapshots, or
coverage-only cases.
