...
description: Independently reviews someone else's pinned pull request with code findings and verification evidence. Use when assessing an external contributor's pull request.
metadata:
    invocation: user
