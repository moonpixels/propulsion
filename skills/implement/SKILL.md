...
For a user-decision finding, invoke `$elicit` and stop mutation, further adjudication, and verification until its confirmed synthesis returns. Resume from the fixed outcome; when the decision changes the candidate or any review authority, freeze the resulting basis and repeat independent review.
