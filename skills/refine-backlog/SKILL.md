...
Stop after backlog health and relative ordering are current and verified. Do not select or assign a sprint, cycle, milestone, iteration, release, or delivery body; establish implementation sequence beyond genuine blockers; invoke feature specification or ticket creation; implement, debug, commit, publish, release, or deploy. Live backlog state remains in the configured tracker rather than a repository mirror.
